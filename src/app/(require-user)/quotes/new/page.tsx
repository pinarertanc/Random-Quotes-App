...
export default function NewQuotePage(){
    ...
    const {register, formState: {errors}, handleSubmit} = useForm({mode: 'onChange', resolver: zodResolver(NewQuoteSchema)});
    ...
    <form autoComplete="off" className="w-full max-w-3xl mx-auto my-20 sm:my-40 px-4 sm:px-8" action={dispatchAction}>
     ...
     <FieldGroup>
          <Field>
            ...
            <Input type="text" id="quote" defaultValue={state.data?.quote} {...register('quote', {required: 'This field is required', 
